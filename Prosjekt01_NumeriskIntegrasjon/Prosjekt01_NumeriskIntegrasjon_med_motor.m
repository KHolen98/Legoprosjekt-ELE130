...
% Kontrollerer tiden og justerer motorhastigheten
if Tid(k) > 4
    % Sett motor A til å gå sakte etter 4 sekunder
    motorA.Speed = 2; % Eksempel: Setter en lav hastighet. Juster dette tallet etter behov.
else
    motorA.Speed = 0; % Normal hastighet før 4 sekunder. Juster dette tallet etter behov.
end

% Starter motor A hvis online
if online
    start(motorA);
end
